...
class options():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--thresholding', type=str, default='scaledOtsu', help='adaptive/otsu/scaledOtsu, adaptive - useful for complex urban areas. Otsu and Scaled Otsu for areas with less spatial complexity')
        parser.add_argument('--otsuScalingFactor', type=float, default=1.25, help='scaling factor is scaled otsu thresholding is used')
        parser.add_argument('--objectMinSize', type=int, default=64, help='minimum size for objects in pixel')
